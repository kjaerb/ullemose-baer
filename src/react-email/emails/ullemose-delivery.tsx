import { FruitName, FruitOrder } from "@/validators/fruitSchema";
...
export default function UllemoseDelivery({
  ...
  function getDeliveryDate(berry: FruitName) {
    switch (berry) {
      case "Solbær":
        return "27. Juli";
      case "Ribs":
        ...
        <Container style={container}>
          ...
          <Section style={box}>
            ...
            <Row>
              ...
              <Column style={halfWidth}>
                <Text style={flexCenterBold}>Afhentning d.</Text>
              </Column>
            </Row>
            {order.fruitOrder.map((fruit, i) => (
              <Row key={i}>
                ...
                <Column style={halfWidth}>
                  <Text style={noWrap}>{getDeliveryDate(fruit.name)}</Text>
                </Column>
              </Row>
            ))}
          </Section>
